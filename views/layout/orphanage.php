...
<head>
    ...
    <link rel="stylesheet" href="/vendor/rich-text/src/richtext.min.css">
    <link href="/vendor/calendar/calendar.css" rel="stylesheet">
    <link rel="shortcut icon" href="/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" type="text/css" href="/vendor/fontawesome/css/all.min.css">
    <script type="text/javascript" src="/vendor/jquery/jquery.min.js"></script>
    <script src="/vendor/rich-text/src/jquery.richtext.min.js"></script>
    <style type="text/css">
        .active{
    ...
    <title><?php echo 'kk' ?></title>
</head>
<body>
    <div id="overlay"></div>
    <div class="background"></div>
    <div>
        <?php include("../views/layout/orphanagenav.php") ?>
    </div>
    <div class="main">
