<div class="flex flex-row justify-center align-middle p-3">
  <div class="flex flex-row justify-center align-middle" >
      <a 
        class="block p-3 bg-blue-400 hover:bg-blue-200  m-2"
        href="/orphanage/report/monthly">Generate Monthly Report</a>
      <a 
        class="block p-3 bg-blue-400 hover:bg-blue-200 m-2"
        href="/orphanage/report/annual">Generate Annual Report</a>
  </div>
<!-- 
